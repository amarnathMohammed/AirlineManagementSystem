...
public class BookFlight extends JFrame implements ActionListener{
    ...
    // Populate unique sources
        String sourceQuery = "SELECT DISTINCT source FROM flight";
        ResultSet rsSource = c.s.executeQuery(sourceQuery);
        while (rsSource.next()) {
        source.add(rsSource.getString("source"));
        }
    
    // Populate unique destinations
        String destinationQuery = "SELECT DISTINCT destination FROM flight";
        ResultSet rsDestination = c.s.executeQuery(destinationQuery);
        while (rsDestination.next()) {
        destination.add(rsDestination.getString("destination"));
        }
